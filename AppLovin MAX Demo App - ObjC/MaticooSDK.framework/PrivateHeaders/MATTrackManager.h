...
+ (void)trackAdRequest:(NSString*)pid adType:(NSInteger)adtype rid:(NSString*)rid isAutoRefresh:(BOOL) isAuto dict:(NSDictionary*)biDictionary;
...
+ (void)trackAdRequestInTraffic:(NSString*)pid adType:(NSInteger)adtype isAutoRefresh:(BOOL) isAuto dict:(NSDictionary*)biDictionary; //广告走网络请求
+ (void)trackAdHitCache:(NSString*)pid adType:(NSInteger)adtype dict:(NSDictionary*)biDictionary rid:(NSString*)rid; //广告走网络请求
...
+ (void)trackClose:(NSString*)pid adType:(NSInteger)adtype dict:(NSDictionary*)biDictionary rid:(NSString*)rid;
...
+ (void)trackPrivacyClick:(NSString *)pid adType:(NSInteger)adtype dict:(NSDictionary*)biDictionary rid:(NSString*)rid;
